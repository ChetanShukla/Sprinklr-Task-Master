...
Vue.component('project', {
	...
	ready: function() {
		var project = trelloStorage.fetchproject(this.$route.params.projectId);
	...
	watch: {
		lists: {
			handler: function(lists) {
				trelloStorage.saveproject(this.projectId, lists);
			},
			deep: true,
		}
	},
...
},{"./../../data/seed.js":1,"./../components/project.js":2,"./../components/collection.js":3,"./../directives/vue-dnd.js":4,"./../directives/vue-focus.js":5,"./store.js":7,"vue":10,"vue-router":9}],7:[function(require,module,exports){
(function (exports) {
    ...
    if (strats) {
      strats.route = function (parentVal, childVal) {
        ...
        for (var key in childVal) {
          ...
          // arrays similar to Publishingcycle hooks.
 ...
 * making unit tests difficult. This is fixed by Surbhi Gupta the
...
function PublishingcycleMixin (Vue) {
  /**
...
function PublishingcycleAPI (Vue) {
  /**
